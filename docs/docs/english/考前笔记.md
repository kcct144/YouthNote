...
1. 选词填空：==and== 前后语法并列（名词/动词短语/介词短语等）
2. 语法选择：==and== 表顺承，==but== 表转折，==or== 表选择
3. 完形填空：==and== 前后并列，==but== 前后相反
4. 阅读理解：阅读时 ==but== 后面往往是重点
5. 回答问题：==or== 可能构成选择疑问句，答案二选一
...
| 不定限定词 | some, any, other, another, few, little<br>many, much, a lot of, lots of |
...
All in all, for me, I will pay more attention to 主题. 
Let's take action!
```
...
I'll never forget the day when I fail the exam.

At first, I felt so nervous that I was about to give up. 
Then, it was my friend who encouraged me to keep trying. Gradually, 
my grades got better and better, and I became more confident.
...
==最低成本草稿：==
1. People like lion dance and paper cutting best.
2. My favorite is lion dance.
3. I hope you can come and vote.
...
==最低成本草稿：==
1. I want to be the English guide.
2. I am good at speaking English.
3. I like history very much.

---

### D6 · 记叙文话题改装

> 背熟记叙文，稍微替换能解决很多话题。开头和结尾尽量把话题词用上。
