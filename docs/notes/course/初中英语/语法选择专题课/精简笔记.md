...
| 名   | 有 ‘s 或 s’ 的选项                       |
| 非   | 有 to do                                 |
| 介   | 出现常见介词 in, on, of, with, for       |
| 连   | 出现常见连词 and, but, if, because, when |
| 比   | 有 -er / -est 结尾，或有 more/most       |
| 冠   | a/an/the                                 |
| 词   | 同词根，后缀不同                         |
...
其他思路：3. 看句意4. 时间排除法（过去/现在/将来）5. 状态排除法（一般/进行/完成）
